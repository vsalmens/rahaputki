...
| `koneen-asetukset.txt` | koneen omat asetukset (mm. `tietokansio`), koodin juuressa; syntyy ensikäynnistyksessä mallipohjasta `koodi/koneen-asetukset.esimerkki.txt` |
